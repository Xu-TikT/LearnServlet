  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      { 
         ...
         J.dialog.get({id: 'haoyue_creat',title: '购物成功',width: 600,height:400, link: '<%=path%>/servletCart/CartServlet?id='+id+'&num='+num+'&action=add', cover:true});
      }
      function add()
      {
      ...
      <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td width="70%" valign="top">
             ...
             <div id="cart">
               <img src="images/buy_now.png"><a href="javascript:selflog_show(<%=item.getId()%>)"><img src="images/in_cart.png"></a><a href="servletCart/CartServlet?action=show"><img src="images/view_cart.jpg"/></a>
             </div>
          </td>
          <% 
            }
